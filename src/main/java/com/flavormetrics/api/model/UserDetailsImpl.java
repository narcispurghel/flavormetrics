...
public record UserDetailsImpl(
        ...
        @NotEmpty
        @JsonIgnore
        Set<Authority> authorities) implements UserDetails {
    ...
    public boolean equals(Object o) {
        ...
        return isEnabled == that.isEnabled && isAccountNonLocked == that.isAccountNonLocked &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(email, passwordHash, isAccountNonExpired, isAccountNonLocked,
