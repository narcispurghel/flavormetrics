...
public class UserDto {
    ...
    public boolean equals(Object o) {
        ...
        return isAccountNonExpired == userDto.isAccountNonExpired &&
                ...
                isEnabled == userDto.isEnabled && Objects.equals(id, userDto.id) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, isAccountNonExpired, isAccountNonLocked,
                isCredentialsNonExpired, isEnabled, updatedAt, createdAt, email);
    }
    ...
    public String toString() {
        ...
        sb.append(", authorities=").append(Optional.ofNullable(authorities).orElse(Collections.emptySet()).size());
        sb.append(", ratings=").append(Optional.ofNullable(ratings).orElse(Collections.emptySet()).size());
        sb.append(", recipes=").append(Optional.ofNullable(recipes).orElse(Collections.emptySet()).size());
        sb.append('}');
        return sb.toString();
    }
