...
class AllergyTest {
    ...
    class ConstructorTests {
        ...
        void allergyTypeConstructor_shouldSetFields() {
            ...
            assertEquals(AllergyType.PEANUTS.getDescription(), allergyFromType.getDescription());
        ...
        @Test
        @DisplayName("Constructor with UUID should only set updatedAt (and not the ID)")
    ...
    class GetterSetterTests {
        ...
        void setProfiles_shouldUseDefensiveCopy() {
            ...
            assertEquals(1, allergy.getProfiles().size(), "Internal set should not be affected by changes to the original set.");
        }
        ...
        void getProfiles_shouldReturnDefensiveCopy() {
            ...
            assertTrue(allergy.getProfiles().isEmpty(), "Internal set should not be modifiable from the outside.");
        }
    }
